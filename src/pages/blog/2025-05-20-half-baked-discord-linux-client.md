...
![Discord's 'Must be your lucky day, there's a new update!' dialog](/img/blog/33.png)
![Loads of .deb files for various versions of the Discord for Linux client](/img/blog/34.png)
...
![Discord Linux client titlebar when logged out](/img/blog/35.png)

It became even weirder was when Discord rolled out its desktop+web redesign last March:
![Discord Linux client titlebar when logged in](/img/blog/37.png)
